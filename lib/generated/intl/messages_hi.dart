...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "bitbucketAccount" : MessageLookupByLibrary.simpleMessage("बीटबुकेत खाता"),
    ...
    "follow" : MessageLookupByLibrary.simpleMessage("फ़ोल्लोव"),
    "followSystem" : MessageLookupByLibrary.simpleMessage("सिस्टम का पालन करें"),
    ...
    "longPressToRemoveAccount" : MessageLookupByLibrary.simpleMessage("खाता हटाने के लिए लंबी प्रेस"),
    "markdownRenderEngine" : MessageLookupByLibrary.simpleMessage("मार्कडौं  रेंडर इंजन"),
    ...
    "notFoundTextDisplay" : MessageLookupByLibrary.simpleMessage("यह पृष्ठ कार्यान्वित नहीं है"),
    ...
    "permissionRequiredMessage" : MessageLookupByLibrary.simpleMessage("गिट्टूच के लीये इन अनुमतियों की आवश्यकता है"),
    "pinnedRepositories" : MessageLookupByLibrary.simpleMessage("पिन्नेद रेपोसिटोरिएस"),
    "popularRepositories" : MessageLookupByLibrary.simpleMessage("प्रसिद्ध रेपोसिटोरिएस"),
    "project" : MessageLookupByLibrary.simpleMessage("परियोजना"),
    "projectActions" : MessageLookupByLibrary.simpleMessage("परियोजना की कार्रवाई"),
    "projects" : MessageLookupByLibrary.simpleMessage("परियोजनाओं"),
    "pullRequests" : MessageLookupByLibrary.simpleMessage("पुल्ल रिक्वेस्ट्स"),
    ...
    "repositoryActions" : MessageLookupByLibrary.simpleMessage("रिपॉजिटरी कार्रवाई"),
    "reviewPermissions" : MessageLookupByLibrary.simpleMessage("अनुमति की समीक्षा करें"),
    ...
    "somethingBadHappens" : MessageLookupByLibrary.simpleMessage("त्रुटि हुई है: "),
    "sourceCode" : MessageLookupByLibrary.simpleMessage("एप्लिकेशन स्रोत कोड"),
    "stars" : MessageLookupByLibrary.simpleMessage("स्टार्स"),
    "submitAnIssue" : MessageLookupByLibrary.simpleMessage("एक मुद्दा प्रस्तुत करें"),
    "switchAccounts" : MessageLookupByLibrary.simpleMessage("खाते बदलें"),
    "syntaxHighlighting" : MessageLookupByLibrary.simpleMessage("सिंटेक्स हाइलाइटिंग"),
